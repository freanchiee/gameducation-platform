...
import { getByShareSlug, forkActivity } from "@/lib/data/activities";
import type { Activity, SlideType } from "@/types";
...
export default function SharedActivityPage() {
  ...
  const makeCopy = async () => {
    ...
    router.push(`/dashboard/activities/new?id=${copy.id}`);
  };
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-screen gap-3 px-6 text-center">
        ...
        <p className="text-sm max-w-sm" style={{ color: "var(--color-muted)" }}>
          This share link is invalid or the activity was removed.
        </p>
    ...
    <div className="min-h-screen" style={{ backgroundColor: "var(--color-surface, #f8fafc)" }}>
      ...
      <main className="max-w-2xl mx-auto px-6 py-10">
        ...
        <p className="text-center text-xs mt-6" style={{ color: "var(--color-subtle)" }}>
          ...
          <Link href="/dashboard/activities" className="underline inline-flex items-center gap-0.5">
