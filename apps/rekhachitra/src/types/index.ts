...
/** Who can reach a shared activity by link / in the gallery. */
...
export interface Activity {
  ...
  createdAt: string;
  updatedAt: string;
  /** Sharing (durable store). Minted on first save. */
  visibility?: ActivityVisibility;
  shareSlug?: string;
  /** Source activity id when this was copied from a shared link. */
